...
pub trait Predictable: BaseNetwork + Writable + Readable {
    ...
    fn feedforward_layer(&mut self, layer_i: usize) {
        ...
        let layer_activation_func = self.get_activation_func(layer_i - 1).function;
